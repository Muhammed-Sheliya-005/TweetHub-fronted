    ...
    <main className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-900 via-indigo-900 to-purple-900 text-white px-6 py-12">
      ...
      <div className="max-w-4xl w-full space-y-10">
        ...
        <div className="grid md:grid-cols-2 gap-10">
          {/* Contact Form */}
          <form className="bg-white/10 backdrop-blur-md rounded-2xl shadow-lg p-8 space-y-6">
            <div>
              <label className="block text-left mb-2 text-gray-200 font-medium">
                Name
              </label>
              <input
                type="text"
            ...
            <button
              type="submit"
              className="w-full px-6 py-3 bg-yellow-400 text-indigo-900 font-semibold rounded-lg hover:bg-yellow-300 transition duration-300"
            >
              Send Message
            </button>
          </form>
          ...
          {/* Extra Info */}
          <div className="flex flex-col justify-center bg-white/10 backdrop-blur-md rounded-2xl shadow-lg p-8 space-y-6">
